...
// 桌面顶边栏 (现代面板式标签工作区, Tauri 下兼作标题栏): 左 = logo;
...
import { toggleFileRoot } from "./store"

export default function TopBar() {
  const dragRegion = useTauriDragRegion()

  return (
    <header className="relative z-30 hidden h-11 min-w-0 shrink-0 items-center gap-2 overflow-hidden border-b bg-card px-3 md:flex">
      <Link
        href="/home"
