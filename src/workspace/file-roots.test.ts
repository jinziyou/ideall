...
test("file roots: 新路径与旧深链 alias 都打开真实目录及其语义 Engine", () => {
  const fixtures = [
    {
      paths: ["/home/following", "/home/subscriptions"],
    ...
    {
      paths: ["/settings/basic", "/home/settings"],
