...
import type { Subscription } from "@/app/home/model"
import { getSubscription } from "@/app/home/lib/subscriptions-store"
        ...
        <ul className="flex flex-col gap-3">
          {items.map((it) => (
            <li key={it.key} className="flex flex-col gap-0.5 border-b pb-3 last:border-0">
              ...
              {it.body && <span className="line-clamp-2 text-xs text-muted-foreground">{it.body}</span>}
