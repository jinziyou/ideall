...
import { Bookmark, Bot, ChevronRight, File as FileIcon, FileText, Folder, Loader2, Rss } from "lucide-react"
import { cn } from "@/components/lib/utils"
import { onHubUpdated } from "@protocol/flowback"
import type { NodeKind } from "@protocol/node"
import { listNodeSummaries, type NodeSummary } from "@/app/home/lib/nodes-store"
import { buildTree, type Tree } from "@/app/home/lib/notes-tree-util"
...
export function NodeTree({
  ...
  // 故 kindKey 在单次挂载内恒定; effect 仅负责首载 + 订阅 HUB_UPDATED 刷新。
  ...
  return (
    <div>
      <div
        ...
        onClick={() => (isFolder ? onToggle(it.id) : onOpen({ kind: it.kind, id: it.id }, it.title))}
