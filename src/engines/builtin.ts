...
export const BUILTIN_ENGINES = [
  ...
  },
  {
    ...
    match: {
      kinds: ["file"],
      mediaTypes: ["audio/*", "application/vnd.ideall.audio+json"],
    },
    priority: 900,
    layout: "padded",
    access: "read-only",
  ...
  },
  {
    ...
    match: {
      kinds: ["file"],
      mediaTypes: ["application/vnd.ideall.database+json", "application/x-sqlite3"],
    },
    priority: 880,
    layout: "padded",
    access: "read-write",
  ...
  },
  {
    ...
    match: {
      ...
      mediaTypes: ["inode/directory", "application/vnd.ideall.git+json"],
      properties: { git: true },
    },
    priority: 870,
    layout: "padded",
