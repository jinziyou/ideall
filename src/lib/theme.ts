...
import { THEME_KEY, readPublicConfig, writePublicConfig } from "./public-config"

export { THEME_KEY } from "./public-config"
...
/** 内联到 <body> 顶部的无闪烁脚本（首帧前同步设置 .dark）。 */
